          ...
          <div className="grid gap-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-gray-200 text-gray-800"
              />
            </div>
          </div>
          ...
          <div className="grid gap-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 bg-gray-200 text-gray-800"
              />
              <Eye className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 w-5 h-5 cursor-pointer" />
            </div>
          </div>
